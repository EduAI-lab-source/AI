...
export function LearningStudio({ language, latestAssistantMessage, onAskEdu, onClose, responseStyle, onResponseStyleChange, chatState, onRestoreWorkspace, accountConnected }: LearningStudioProps) {
