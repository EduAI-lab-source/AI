  ...
  es: {
    privacy: {
      ...
      sections: [
        ...
        { heading: "Cookies, almacenamiento y terceros", body: ["Edu AI utiliza almacenamiento local esencial para conservar tus preferencias y tu trabajo en el dispositivo. La interfaz no carga tipografías, anuncios ni recursos visuales de terceros al abrir esta página. El dominio puede usar infraestructura de Cloudflare para la entrega segura y la medición técnica.", "Si en el futuro se habilitan anuncios o analítica opcional, esta página se actualizará antes de activar esas tecnologías y se mostrará una elección de consentimiento cuando corresponda."] },
  ...
  en: {
    privacy: {
      ...
      sections: [
        ...
        { heading: "Cookies, storage and third parties", body: ["Edu AI uses essential local storage to retain your preferences and work on the device. The interface does not load third-party fonts, ads or visual resources when this page opens. The domain may use Cloudflare infrastructure for secure delivery and technical measurement.", "If optional analytics or ads are enabled in the future, this page will be updated before those technologies are activated and a consent choice will be shown where required."] },
  ...
  ru: {
    privacy: {
      ...
      sections: [
        ...
        { heading: "Cookies, хранилище и третьи стороны", body: ["Edu AI использует необходимое локальное хранилище для сохранения ваших настроек и работы на устройстве. При открытии этой страницы интерфейс не загружает сторонние шрифты, рекламу или визуальные ресурсы. Домен может использовать инфраструктуру Cloudflare для безопасной доставки и технических измерений.", "Если в будущем появятся необязательная аналитика или реклама, эта страница будет обновлена до их активации, а при необходимости будет показан выбор согласия."] },
