...
La versión estática publicada en `https://textoavoz.xyz/` conserva el uso local sin requerir una cuenta. La comprobación inicial del panel **Mi espacio → Progreso** confirmó la copia privada local, pero no mostró la invitación de cuenta esperada bajo una sesión pública. Esta discrepancia queda registrada para su corrección y verificación antes de declarar disponible la sincronización por cuenta; no afecta la copia privada con código ni comparte contenido de forma predeterminada.
